...
include('../connect/connect.php');?>
    ...
    <form class="form_sondage-admin" action="../controler/create_user.php" method="post">
        ...
        <div class="inscription__grid">
            ...
            <label for="mdp_user" class="form_label grid-col-3 row-6">MDP admin</label>
            <input type="password" id="mdp_admin" class="grid-col-4 row-6 grid-row" name="mdp_admin" required>
